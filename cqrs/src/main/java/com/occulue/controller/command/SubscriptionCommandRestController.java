...
public class SubscriptionCommandRestController extends BaseSpringRestController {
    ...
    public CompletableFuture<UUID> create( @RequestBody(required=true) CreateSubscriptionCommand command ) {
		...
		try {       
			...
			completableFuture = SubscriptionBusinessDelegate.getSubscriptionInstance().createSubscription( command );
        }
        catch( Throwable exc ) {
    ...
    public CompletableFuture<Void> update( @RequestBody(required=true) UpdateSubscriptionCommand command ) {
		...
		try {                        	        
			...
			// -----------------------------------------------
			completableFuture = SubscriptionBusinessDelegate.getSubscriptionInstance().updateSubscription(command);;
	    }
	    catch( Throwable exc ) {
    ...
    public CompletableFuture<Void> delete( @RequestParam(required=true) UUID subscriptionId  ) {
    	...
    	try {
        	SubscriptionBusinessDelegate delegate = SubscriptionBusinessDelegate.getSubscriptionInstance();
	...
	public void unAssignProgram( @RequestBody(required=true)  UnAssignProgramFromSubscriptionCommand command ) {
		try {
	...
	public void addToObjectOperations( @RequestBody(required=true) AssignObjectOperationsToSubscriptionCommand command ) {
		try {
	...
	public void removeFromObjectOperations( 	@RequestBody(required=true) RemoveObjectOperationsFromSubscriptionCommand command )
	{		
		try {
