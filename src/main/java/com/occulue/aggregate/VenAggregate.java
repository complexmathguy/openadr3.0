...
/**
 * Aggregate handler for Ven as outlined for the CQRS pattern, all write responsibilities 
 * related to Ven are handled here.
 * 
...
public class VenAggregate {  
    ...
    public VenAggregate(CreateVenCommand command) throws Exception {
    	...
    	CreateVenEvent event = new CreateVenEvent(command.getVenId(), command.getCreatedDateTime(), command.getModificationDateTime(), command.getVenName(), command.getAttributes(), command.getTargets(), command.getObjectType());
    ...
    public void handle(UpdateVenCommand command) throws Exception {
    	...
    	UpdateVenEvent event = new UpdateVenEvent(command.getVenId(), command.getCreatedDateTime(), command.getModificationDateTime(), command.getVenName(), command.getAttributes(), command.getTargets(), command.getResources(), command.getObjectType());        
