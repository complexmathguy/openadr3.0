...
public class ResourceAggregate {  
    ...
    public ResourceAggregate(CreateResourceCommand command) throws Exception {
    	...
    	CreateResourceEvent event = new CreateResourceEvent(command.getResourceId(), command.getCreatedDateTime(), command.getModificationDateTime(), command.getResourceName(), command.getAttributes(), command.getTargets(), command.getObjectType());
    ...
    public void handle(UpdateResourceCommand command) throws Exception {
    	...
    	UpdateResourceEvent event = new UpdateResourceEvent(command.getResourceId(), command.getCreatedDateTime(), command.getModificationDateTime(), command.getResourceName(), command.getVen(), command.getAttributes(), command.getTargets(), command.getObjectType());        
    ...
    public void handle(AssignVenToResourceCommand command) throws Exception {
    	...
    	if (  ven != null && ven.getVenId() == command.getAssignment().getVenId() )
    		throw new ProcessingException( "Ven already assigned with id " + command.getAssignment().getVenId() );  
    ...
    public void handle(UnAssignVenFromResourceCommand command) throws Exception {
    	...
    	if (  ven == null )
    		throw new ProcessingException( "Ven already has nothing assigned." );  
    ...
    public void handle(AssignAttributesToResourceCommand command) throws Exception {
    	...
    	if ( attributes.contains( command.getAddTo() ) )
    		throw new ProcessingException( "Attributes already contains an entity with id " + command.getAddTo().getValuesMapId() );
    ...
    public void handle(RemoveAttributesFromResourceCommand command) throws Exception {
    	...
    	if ( !attributes.contains( command.getRemoveFrom() ) )
    		throw new ProcessingException( "Attributes does not contain an entity with id " + command.getRemoveFrom().getValuesMapId() );
