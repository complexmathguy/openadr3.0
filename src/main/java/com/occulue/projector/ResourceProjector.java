...
/**
 * Projector for Resource as outlined for the CQRS pattern.  All event handling and query handling related to Resource are invoked here
 * and dispersed as an event to be handled elsewhere.
 * 
 * Commands are handled by ResourceAggregate
 * 
...
public void handle( RemoveTargetsFromResourceEvent event) {
	...
	/**
	 * emit to subscription queries of type FindResource, 
	...
	protected void emitFindResource( Resource entity ) {
	    ...
	    queryUpdateEmitter.emit(FindResourceQuery.class,
	...
	protected void emitFindAllResource( Resource entity ) {
	    ...
	    queryUpdateEmitter.emit(FindAllResourceQuery.class,
	                            query -> true,
	                            entity);
	}
