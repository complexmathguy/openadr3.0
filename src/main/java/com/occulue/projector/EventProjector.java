...
/**
 * Projector for Event as outlined for the CQRS pattern.  All event handling and query handling related to Event are invoked here
 * and dispersed as an event to be handled elsewhere.
 * 
 * Commands are handled by EventAggregate
 * 
...
public void handle( RemoveIntervalsFromEventEvent event) {
    ...
    @QueryHandler
    public Event handle( FindEventQuery query ) 
	...
	/**
	 * emit to subscription queries of type FindEvent, 
	...
	protected void emitFindEvent( Event entity ) {
	    ...
	    queryUpdateEmitter.emit(FindEventQuery.class,
	...
	protected void emitFindAllEvent( Event entity ) {
	    ...
	    queryUpdateEmitter.emit(FindAllEventQuery.class,
	                            query -> true,
	                            entity);
	}
