...
/**
 * Projector for Notification as outlined for the CQRS pattern.  All event handling and query handling related to Notification are invoked here
...
public class NotificationProjector extends NotificationEntityProjector {
	...
	// core constructor
	public NotificationProjector(NotificationRepository repository, QueryUpdateEmitter queryUpdateEmitter ) {
        super(repository);
	...
	/**
	 * emit to subscription queries of type FindNotification, 
	...
	protected void emitFindNotification( Notification entity ) {
	    ...
	    queryUpdateEmitter.emit(FindNotificationQuery.class,
	...
	protected void emitFindAllNotification( Notification entity ) {
	    ...
	    queryUpdateEmitter.emit(FindAllNotificationQuery.class,
	                            query -> true,
	                            entity);
	}
