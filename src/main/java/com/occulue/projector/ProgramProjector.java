...
/**
 * Projector for Program as outlined for the CQRS pattern.  All event handling and query handling related to Program are invoked here
...
public void handle( RemoveTargetsFromProgramEvent event) {
	...
	/**
	 * emit to subscription queries of type FindProgram, 
	...
	protected void emitFindProgram( Program entity ) {
	    ...
	    queryUpdateEmitter.emit(FindProgramQuery.class,
	...
	protected void emitFindAllProgram( Program entity ) {
	    ...
	    queryUpdateEmitter.emit(FindAllProgramQuery.class,
	                            query -> true,
	                            entity);
	}
