...
/**
 * Projector for Ven as outlined for the CQRS pattern.  All event handling and query handling related to Ven are invoked here
 * and dispersed as an event to be handled elsewhere.
 * 
 * Commands are handled by VenAggregate
 * 
...
public void handle( RemoveResourcesFromVenEvent event) {
    ...
    @QueryHandler
    public Ven handle( FindVenQuery query ) 
	...
	/**
	 * emit to subscription queries of type FindVen, 
	...
	protected void emitFindVen( Ven entity ) {
	    ...
	    queryUpdateEmitter.emit(FindVenQuery.class,
	...
	protected void emitFindAllVen( Ven entity ) {
	    ...
	    queryUpdateEmitter.emit(FindAllVenQuery.class,
	                            query -> true,
	                            entity);
	}
