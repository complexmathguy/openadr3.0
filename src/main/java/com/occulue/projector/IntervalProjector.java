...
/**
 * Projector for Interval as outlined for the CQRS pattern.  All event handling and query handling related to Interval are invoked here
 * and dispersed as an event to be handled elsewhere.
 * 
 * Commands are handled by IntervalAggregate
 * 
...
public void handle( RemovePayloadsFromIntervalEvent event) {
	...
	/**
	 * emit to subscription queries of type FindInterval, 
	...
	protected void emitFindInterval( Interval entity ) {
	    ...
	    queryUpdateEmitter.emit(FindIntervalQuery.class,
	...
	protected void emitFindAllInterval( Interval entity ) {
	    ...
	    queryUpdateEmitter.emit(FindAllIntervalQuery.class,
	                            query -> true,
	                            entity);
	}
