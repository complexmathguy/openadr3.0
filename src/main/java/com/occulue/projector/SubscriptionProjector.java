...
/**
 * Projector for Subscription as outlined for the CQRS pattern.  All event handling and query handling related to Subscription are invoked here
 * and dispersed as an event to be handled elsewhere.
 * 
 * Commands are handled by SubscriptionAggregate
 * 
...
public class SubscriptionProjector extends SubscriptionEntityProjector {
	...
	// core constructor
	public SubscriptionProjector(SubscriptionRepository repository, QueryUpdateEmitter queryUpdateEmitter ) {
        super(repository);
...
public void handle( RemoveObjectOperationsFromSubscriptionEvent event) {
    ...
    Subscription entity = removeFromObjectOperations(event.getSubscriptionId(), event.getRemoveFrom() );
