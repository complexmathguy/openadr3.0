...
/**
 * Projector for ReportDescriptor as outlined for the CQRS pattern.  All event handling and query handling related to ReportDescriptor are invoked here
...
public class ReportDescriptorProjector extends ReportDescriptorEntityProjector {
	...
	// core constructor
	public ReportDescriptorProjector(ReportDescriptorRepository repository, QueryUpdateEmitter queryUpdateEmitter ) {
        super(repository);
    ...
    @SuppressWarnings("unused")
    @QueryHandler
    public List<ReportDescriptor> handle( FindAllReportDescriptorQuery query ) throws ProcessingException {
    	return findAll( query );
    }


	/**
	 * emit to subscription queries of type FindReportDescriptor, 
	...
	protected void emitFindReportDescriptor( ReportDescriptor entity ) {
	    ...
	    queryUpdateEmitter.emit(FindReportDescriptorQuery.class,
	...
	protected void emitFindAllReportDescriptor( ReportDescriptor entity ) {
	    ...
	    queryUpdateEmitter.emit(FindAllReportDescriptorQuery.class,
	                            query -> true,
	                            entity);
	}
