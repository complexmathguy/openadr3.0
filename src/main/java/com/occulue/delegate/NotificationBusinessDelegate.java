 ...
 * <li>Improving the available of Notification related services in the case of a Notification business related service failing.</li>
 * <li>Exposes a simpler, uniform Notification interface to the business tier, making it easy for clients to consume a simple Java object.</li>
 * <li>Hides the communication protocol that may be required to fulfill Notification business related services.</li>
 * </ol>
 * <p>
 * @author your_name_here
 */
public class NotificationBusinessDelegate 
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
			...
			if ( command.getNotificationId() == null )
				command.setNotificationId( UUID.randomUUID() );
    		...
    		// ---------------------------------------
    		// issue the CreateNotificationCommand - by convention the future return value for a create command
        	// that is handled by the constructor of an aggregate will return the UUID 
    		// ---------------------------------------
        	completableFuture = commandGateway.send( command );
        	
			LOGGER.log( Level.INFO, "return from Command Gateway for CreateNotificationCommand of Notification is " + command );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {	
        ...
        try {  
            ...
            final String errMsg = "Unable to delete Notification using Id = "  + command.getNotificationId();
            LOGGER.log( Level.WARNING, errMsg, exc );
            throw new ProcessingException( errMsg, exc );
        }
        finally {
    ...
    throws ProcessingException, IllegalArgumentException {
        ...
        try {
        	...
        	// --------------------------------------
        	CompletableFuture<Notification> futureEntity = queryGateway.query(new FindNotificationQuery( new LoadNotificationFilter( summary.getNotificationId() ) ), ResponseTypes.instanceOf(Notification.class));
    ...
    throws ProcessingException {
        ...
        try {
        	CompletableFuture<List<Notification>> futureList = queryGateway.query(new FindAllNotificationQuery(), ResponseTypes.multipleInstancesOf(Notification.class));
     ...
     * @exception	ProcessingException
     */     
	public void assignNotifier( AssignNotifierToNotificationCommand command ) throws ProcessingException {
		...
		NotificationBusinessDelegate parentDelegate = NotificationBusinessDelegate.getNotificationInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignNotifier( UnAssignNotifierFromNotificationCommand command ) throws ProcessingException {
	 ...
	 * @return		Notification
	 */
	protected Notification load( UUID id ) throws ProcessingException {
		notification = NotificationBusinessDelegate.getNotificationInstance().getNotification( new NotificationFetchOneSummary(id) );	
		return notification;
	}
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(NotificationBusinessDelegate.class.getName());
