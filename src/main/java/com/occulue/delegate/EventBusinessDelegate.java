 ...
 * <li>Improving the available of Event related services in the case of a Event business related service failing.</li>
 * <li>Exposes a simpler, uniform Event interface to the business tier, making it easy for clients to consume a simple Java object.</li>
 * <li>Hides the communication protocol that may be required to fulfill Event business related services.</li>
 * </ol>
 * <p>
 * @author your_name_here
 */
public class EventBusinessDelegate 
extends NotifierBusinessDelegate {
//************************************************************************
// Public Methods
//************************************************************************
    /** 
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
			...
			LOGGER.log( Level.INFO, "return from Command Gateway for CreateEventCommand of Event is " + command );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
        ...
        try {
        	...
        	// --------------------------------------
        	CompletableFuture<Event> futureEntity = queryGateway.query(new FindEventQuery( new LoadEventFilter( summary.getEventId() ) ), ResponseTypes.instanceOf(Event.class));
    ...
    throws ProcessingException {
        ...
        try {
        	CompletableFuture<List<Event>> futureList = queryGateway.query(new FindAllEventQuery(), ResponseTypes.multipleInstancesOf(Event.class));
     ...
     * @exception	ProcessingException
     */     
	public void assignIntervalPeriod( AssignIntervalPeriodToEventCommand command ) throws ProcessingException {
		...
		IntervalPeriodBusinessDelegate childDelegate 	= IntervalPeriodBusinessDelegate.getIntervalPeriodInstance();
		EventBusinessDelegate parentDelegate = EventBusinessDelegate.getEventInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignIntervalPeriod( UnAssignIntervalPeriodFromEventCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void addToReportDescriptors( AssignReportDescriptorsToEventCommand command ) throws ProcessingException {
		...
		ReportDescriptorBusinessDelegate childDelegate 	= ReportDescriptorBusinessDelegate.getReportDescriptorInstance();
		EventBusinessDelegate parentDelegate = EventBusinessDelegate.getEventInstance();		
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromReportDescriptors( RemoveReportDescriptorsFromEventCommand command ) throws ProcessingException {		
     ...
     * @exception	ProcessingException
     */     
	public void addToPayloadDescriptors( AssignPayloadDescriptorsToEventCommand command ) throws ProcessingException {
		...
		PayloadDescriptorBusinessDelegate childDelegate 	= PayloadDescriptorBusinessDelegate.getPayloadDescriptorInstance();
		EventBusinessDelegate parentDelegate = EventBusinessDelegate.getEventInstance();		
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromPayloadDescriptors( RemovePayloadDescriptorsFromEventCommand command ) throws ProcessingException {		
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromIntervals( RemoveIntervalsFromEventCommand command ) throws ProcessingException {		
	 ...
	 * @return		Event
	 */
	protected Event load( UUID id ) throws ProcessingException {
