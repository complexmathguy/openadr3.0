 ...
 */
public class SubscriptionBusinessDelegate 
...
//************************************************************************
    ...
    */
	...
	public void assignProgram( AssignProgramToSubscriptionCommand command ) throws ProcessingException {
		...
		SubscriptionBusinessDelegate parentDelegate = SubscriptionBusinessDelegate.getSubscriptionInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignProgram( UnAssignProgramFromSubscriptionCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void addToObjectOperations( AssignObjectOperationsToSubscriptionCommand command ) throws ProcessingException {
		...
		ObjectOperationBusinessDelegate childDelegate 	= ObjectOperationBusinessDelegate.getObjectOperationInstance();
		SubscriptionBusinessDelegate parentDelegate = SubscriptionBusinessDelegate.getSubscriptionInstance();		
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromObjectOperations( RemoveObjectOperationsFromSubscriptionCommand command ) throws ProcessingException {		
	...
	protected Subscription load( UUID id ) throws ProcessingException {
		subscription = SubscriptionBusinessDelegate.getSubscriptionInstance().getSubscription( new SubscriptionFetchOneSummary(id) );	
		return subscription;
	}
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(SubscriptionBusinessDelegate.class.getName());
