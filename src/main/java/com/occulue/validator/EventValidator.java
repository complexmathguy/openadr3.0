...
public class EventValidator {
	 ...
	 * factory method
	 */
	static public EventValidator getInstance() {
...
//		Assert.isNull( event.getEventId(), "CreateEventCommand identifier should be null" );
		Assert.notNull( event.getCreatedDateTime(), "Field CreateEventCommand.createdDateTime should not be null" );
		Assert.notNull( event.getModificationDateTime(), "Field CreateEventCommand.modificationDateTime should not be null" );
	...
	public void validate( UpdateEventCommand event ) throws Exception {
		...
		Assert.notNull( event.getCreatedDateTime(), "Field UpdateEventCommand.createdDateTime should not be null" );
		Assert.notNull( event.getModificationDateTime(), "Field UpdateEventCommand.modificationDateTime should not be null" );
	...
	public void validate( AssignProgramToEventCommand command ) throws Exception {
		...
		Assert.notNull( command.getEventId(), "AssignProgramToEventCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignProgramToEventCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignProgramFromEventCommand command ) throws Exception {
		...
		Assert.notNull( command.getEventId(), "UnAssignProgramFromEventCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignIntervalPeriodToEventCommand command ) throws Exception {
		...
		Assert.notNull( command.getEventId(), "AssignIntervalPeriodToEventCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIntervalPeriodToEventCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIntervalPeriodFromEventCommand command ) throws Exception {
		...
		Assert.notNull( command.getEventId(), "UnAssignIntervalPeriodFromEventCommand identifier should not be null" );
	}
	...
	public void validate( AssignReportDescriptorsToEventCommand command ) throws Exception {
		...
		Assert.notNull( command.getEventId(), "AssignReportDescriptorsToEventCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignReportDescriptorsToEventCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveReportDescriptorsFromEventCommand command ) throws Exception {
		...
		Assert.notNull( command.getEventId(), "RemoveReportDescriptorsFromEventCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveReportDescriptorsFromEventCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getReportDescriptorId(), "RemoveReportDescriptorsFromEventCommand removeFrom attribubte identifier should not be null" );
	}
	...
	public void validate( AssignPayloadDescriptorsToEventCommand command ) throws Exception {
		...
		Assert.notNull( command.getEventId(), "AssignPayloadDescriptorsToEventCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignPayloadDescriptorsToEventCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemovePayloadDescriptorsFromEventCommand command ) throws Exception {
		...
		Assert.notNull( command.getEventId(), "RemovePayloadDescriptorsFromEventCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemovePayloadDescriptorsFromEventCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getPayloadDescriptorId(), "RemovePayloadDescriptorsFromEventCommand removeFrom attribubte identifier should not be null" );
	}
	...
	public void validate( AssignIntervalsToEventCommand command ) throws Exception {
		...
		Assert.notNull( command.getEventId(), "AssignIntervalsToEventCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignIntervalsToEventCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveIntervalsFromEventCommand command ) throws Exception {
		...
		Assert.notNull( command.getEventId(), "RemoveIntervalsFromEventCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveIntervalsFromEventCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getIntervalId(), "RemoveIntervalsFromEventCommand removeFrom attribubte identifier should not be null" );
	}
