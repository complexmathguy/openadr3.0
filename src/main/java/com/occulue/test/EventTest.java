...
public class EventTest{
	...
	protected void jumpStart() throws Throwable {
		...
		eventId = EventBusinessDelegate.getEventInstance()
		.createEvent( generateNewCommand() )
		.get();
	...
	protected void setUpQuerySubscriptions() throws Throwable {
		...
		try {            
			subscriber.eventSubscribe().updates().subscribe(
					  successValue -> {
			...
			subscriber.eventSubscribe( eventId ).updates().subscribe(
					  successValue -> {
						  LOGGER.info(successValue.toString());
						  try {
							  LOGGER.info("GetOne update received for Event : " + successValue.getEventId() + " in step " + testingStep);
							  testingStep = "delete";
	...
	protected void update() throws Throwable {
		...
		try {            
			...
			LOGGER.warning( unexpectedErrorMsg );
			LOGGER.warning( msg.toString() + " : primarykey = " + eventId + " : command -" +  command + " : " + e );
	...
	protected void delete() throws Throwable {
		...
		try{
			EventBusinessDelegate.getEventInstance().delete( new DeleteEventCommand( entity.getEventId() ) ).get();
	...
	protected CreateEventCommand generateNewCommand() {
        CreateEventCommand command = new CreateEventCommand( null,   new Date(),   new Date(),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  0,  new ValuesMap(),  ObjectType.values()[0] );
	...
	protected UpdateEventCommand generateUpdateCommand() {
	        UpdateEventCommand command = new UpdateEventCommand( null,   new Date(),   new Date(),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  0,  null,  new ValuesMap(),  new HashSet<>(),  new HashSet<>(),  new HashSet<>(),  ObjectType.values()[0],  null );
