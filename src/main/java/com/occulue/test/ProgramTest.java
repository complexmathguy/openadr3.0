...
public class ProgramTest{
	...
	protected void jumpStart() throws Throwable {
		...
		programId = ProgramBusinessDelegate.getProgramInstance()
		.createProgram( generateNewCommand() )
		.get();
	...
	protected void setUpQuerySubscriptions() throws Throwable {
		...
		try {            
			subscriber.programSubscribe().updates().subscribe(
					  successValue -> {
						  LOGGER.info(successValue.toString());
						  try {
							  LOGGER.info("GetAll update received for Program : " + successValue.getProgramId());
							  if (successValue.getProgramId().equals(programId)) {
								  if (testingStep.equals("create")) {
									  ...
									  state( getAll().size() == sizeOfProgramList - 1 , "value not deleted from list");
									  LOGGER.info("**********************************************************");
			...
			subscriber.programSubscribe( programId ).updates().subscribe(
					  successValue -> {
						  LOGGER.info(successValue.toString());
						  try {
							  LOGGER.info("GetOne update received for Program : " + successValue.getProgramId() + " in step " + testingStep);
							  testingStep = "delete";
	...
	protected void update() throws Throwable {
		...
		try {            
			...
			LOGGER.warning( unexpectedErrorMsg );
			LOGGER.warning( msg.toString() + " : primarykey = " + programId + " : command -" +  command + " : " + e );
	...
	protected void delete() throws Throwable {
		...
		try{
			ProgramBusinessDelegate.getProgramInstance().delete( new DeleteProgramCommand( entity.getProgramId() ) ).get();
	...
	protected CreateProgramCommand generateNewCommand() {
        CreateProgramCommand command = new CreateProgramCommand( null,   new Date(),   new Date(),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),   "",  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  new Boolean(true),  new Boolean(true),  new HashSet<>(),  ObjectType.values()[0] );
	...
	protected UpdateProgramCommand generateUpdateCommand() {
	        UpdateProgramCommand command = new UpdateProgramCommand( null,   new Date(),   new Date(),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),   "",  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  new Boolean(true),  new Boolean(true),  new HashSet<>(),  new HashSet<>(),  ObjectType.values()[0],  null );
