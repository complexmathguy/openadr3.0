...
public class SubscriptionTest{
	...
	protected void jumpStart() throws Throwable {
		...
		subscriptionId = SubscriptionBusinessDelegate.getSubscriptionInstance()
	...
	protected Subscription read() throws Throwable {
		...
		try {
			entity = SubscriptionBusinessDelegate.getSubscriptionInstance().getSubscription( fetchOneSummary );
	...
	protected void delete() throws Throwable {
		...
		try{
			SubscriptionBusinessDelegate.getSubscriptionInstance().delete( new DeleteSubscriptionCommand( entity.getSubscriptionId() ) ).get();
	...
	protected CreateSubscriptionCommand generateNewCommand() {
        CreateSubscriptionCommand command = new CreateSubscriptionCommand( null,   new Date(),   new Date(),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  new ValuesMap(),  ObjectType.values()[0] );
	...
	protected UpdateSubscriptionCommand generateUpdateCommand() {
	        UpdateSubscriptionCommand command = new UpdateSubscriptionCommand( null,   new Date(),   new Date(),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  null,  new HashSet<>(),  new ValuesMap(),  ObjectType.values()[0] );
