...
public class ReportDescriptorTest{
	...
	protected void jumpStart() throws Throwable {
		...
		reportDescriptorId = ReportDescriptorBusinessDelegate.getReportDescriptorInstance()
	...
	protected void setUpQuerySubscriptions() throws Throwable {
		...
		try {            
			subscriber.reportDescriptorSubscribe().updates().subscribe(
					  successValue -> {
						  LOGGER.info(successValue.toString());
						  try {
							  LOGGER.info("GetAll update received for ReportDescriptor : " + successValue.getReportDescriptorId());
							  if (successValue.getReportDescriptorId().equals(reportDescriptorId)) {
								  if (testingStep.equals("create")) {
									  ...
									  state( getAll().size() == sizeOfReportDescriptorList - 1 , "value not deleted from list");
									  LOGGER.info("**********************************************************");
			...
			subscriber.reportDescriptorSubscribe( reportDescriptorId ).updates().subscribe(
					  successValue -> {
						  LOGGER.info(successValue.toString());
						  try {
							  LOGGER.info("GetOne update received for ReportDescriptor : " + successValue.getReportDescriptorId() + " in step " + testingStep);
							  testingStep = "delete";
	...
	protected ReportDescriptor read() throws Throwable {
		...
		ReportDescriptorFetchOneSummary fetchOneSummary = new ReportDescriptorFetchOneSummary( reportDescriptorId );

		try {
			entity = ReportDescriptorBusinessDelegate.getReportDescriptorInstance().getReportDescriptor( fetchOneSummary );
	...
	protected void update() throws Throwable {
		...
		try {            
			...
			ReportDescriptorBusinessDelegate proxy = ReportDescriptorBusinessDelegate.getReportDescriptorInstance();  
			...
			LOGGER.warning( unexpectedErrorMsg );
			LOGGER.warning( msg.toString() + " : primarykey = " + reportDescriptorId + " : command -" +  command + " : " + e );
	...
	protected void delete() throws Throwable {
		...
		try{
			ReportDescriptorBusinessDelegate.getReportDescriptorInstance().delete( new DeleteReportDescriptorCommand( entity.getReportDescriptorId() ) ).get();
	...
	protected List<ReportDescriptor> getAll() throws Throwable {    
		...
		try {
			...
			collection = ReportDescriptorBusinessDelegate.getReportDescriptorInstance().getAllReportDescriptor();
			assertNotNull( collection, "An Empty collection of ReportDescriptor was incorrectly returned.");
			...
			while( iter.hasNext() ) {
				...
				assertNotNull( entity.getReportDescriptorId(), "-- entity in Collection has a null primary key" );        
	...
	protected CreateReportDescriptorCommand generateNewCommand() {
        CreateReportDescriptorCommand command = new CreateReportDescriptorCommand( null,  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  new Boolean(true),  0,  0,  new Boolean(true),  0,  0,  new ValuesMap() );
	...
	protected UpdateReportDescriptorCommand generateUpdateCommand() {
	        UpdateReportDescriptorCommand command = new UpdateReportDescriptorCommand( null,  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  new Boolean(true),  0,  0,  new Boolean(true),  0,  0,  new ValuesMap() );
