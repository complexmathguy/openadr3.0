...
import ListPayloadDescriptorComponent from './components/ListPayloadDescriptorComponent';
import CreatePayloadDescriptorComponent from './components/CreatePayloadDescriptorComponent';
import UpdatePayloadDescriptorComponent from './components/UpdatePayloadDescriptorComponent';
import ViewPayloadDescriptorComponent from './components/ViewPayloadDescriptorComponent';
                ...
                <div className="container">
                    <Switch>
                          ...
                          {/* <Route path = "/update-objectOperation/:id" component = {UpdateObjectOperationComponent}></Route> */}
                            <Route path = "/payloadDescriptors" component = {ListPayloadDescriptorComponent}></Route>
                            <Route path = "/add-payloadDescriptor/:id" component = {CreatePayloadDescriptorComponent}></Route>
                            <Route path = "/view-payloadDescriptor/:id" component = {ViewPayloadDescriptorComponent}></Route>
                          {/* <Route path = "/update-payloadDescriptor/:id" component = {UpdatePayloadDescriptorComponent}></Route> */}
